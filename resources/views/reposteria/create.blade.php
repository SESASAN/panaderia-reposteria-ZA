<x-Empleado>
  ...
  <div class="form-wrapper">
    ...
    <form action="{{ route('reposteria.store') }}" method="POST">
      ...
      <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" placeholder="Nombre del producto" />
      @error('nombre')
      <p class="error-message">{{ $message }}</p>
      @enderror

      <label for="slug">Slug</label>
      <input type="text" name="slug" id="slug" value="{{ old('slug') }}" placeholder="Slug del producto" />
      @error('slug')
      <p class="error-message">{{ $message }}</p>
      @enderror
      ...
      <input type="number" name="precio" id="precio" value="{{ old('precio') }}" placeholder="Precio del producto" />
      @error('precio')
      <p class="error-message">{{ $message }}</p>
      @enderror
