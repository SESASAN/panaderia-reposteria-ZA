    ...
    {{-- Validación de errores --}}
        ...
        <form action="{{ route('panaderia.update', $producto) }}" method="POST" class="formulario">
            ...
            @method('PUT')
                ...
                <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $producto->nombre) }}" placeholder="Ingrese el nombre del producto">
                @error('nombre')
                    <p class="mensaje-error">{{ $message }}</p>
                @enderror

                <label for="slug">Slug</label>
                <input type="text" name="slug" id="slug" value="{{ old('slug', $producto->slug) }}" placeholder="Ingrese el slug del producto">
                @error('slug')
                    <p class="mensaje-error">{{ $message }}</p>
                @enderror
                ...
                <input type="number" name="precio" id="precio" value="{{ old('precio', $producto->precio) }}" placeholder="Ingrese el precio del producto">
                @error('precio')
                    <p class="mensaje-error">{{ $message }}</p>
                @enderror
