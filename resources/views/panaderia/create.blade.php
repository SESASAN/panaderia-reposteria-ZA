    ...
    <div class="form-wrapper">
        ...
        <form action="{{ route('panaderia.store') }}" method="POST" class="space-y-6">
            @csrf
                ...
                <input
                    type="text" name="slug" id="slug" value="{{ old('slug') }}" placeholder="Slug del producto"/>
                @error('slug')
                    <p class="error-message">{{ $message }}</p>
                @enderror
                ...
                <input
                    type="number" name="precio" id="precio" value="{{ old('precio') }}" placeholder="Precio del producto"/>
                @error('precio')
                    <p class="error-message">{{ $message }}</p>
                @enderror
